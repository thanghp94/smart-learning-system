...
const TaskForm: React.FC<TaskFormProps> = ({ initialData, employees = [], onSubmit, onCancel }) => {
  const form = useForm<TaskFormValues>({
    ...
    defaultValues: {
      ...
      loai_viec: initialData?.loai_viec || "hành chính", // Set default value
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value || "hành chính"}>
                  <FormControl>
                    <SelectTrigger>
                ...
                <Select onValueChange={field.onChange} defaultValue={field.value || undefined}>
                  ...
                  <SelectContent>
                    {employees.length > 0 ? (
                      ...
                      <SelectItem value="placeholder">Chọn người phụ trách</SelectItem>
                    )}
                  </SelectContent>
                </Select>
                <FormMessage />
