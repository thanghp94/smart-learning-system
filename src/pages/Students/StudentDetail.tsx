...
// Fix TypeScript errors by converting Date objects to strings
                ...
                <div className="grid gap-4">
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="font-medium">
                        {new Date(formatDate(selectedStudent.ngay_sinh)).toLocaleDateString("vi-VN")}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 rounded-lg border p-3">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <p className="font-medium">
                        {new Date(formatDate(selectedStudent.han_hoc_phi)).toLocaleDateString("vi-VN")}
                      </p>
                    </div>
                  </div>
                </div>
