...
const StudentForm: React.FC<StudentFormProps> = ({ initialData, onSubmit, onCancel }) => {
  ...
  const form = useForm<StudentFormValues>({
    ...
    defaultValues: {
      ...
      co_so_ID: initialData?.co_so_ID as string || "",
  ...
  const handleSubmit = (values: StudentFormValues) => {
    try {
      ...
      const submissionData = {
        ...values,
        ngay_sinh: values.ngay_sinh ? new Date(values.ngay_sinh) : undefined,
      };
            ...
            render={({ field }) => (
              <FormItem>
                ...
                >
                  <FormControl>
                    <SelectTrigger>
                      <SelectValue placeholder={isLoading ? "Đang tải..." : "Chọn cơ sở"} />
                    </SelectTrigger>
                  </FormControl>
                  <SelectContent>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Mô tả về học sinh" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
