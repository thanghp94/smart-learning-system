...
const KanbanView = () => {
  ...
  const filteredAdmissions = admissions.filter(admission => 
    ...
    (admission.ten_phu_huynh && admission.ten_phu_huynh.toLowerCase().includes(searchQuery.toLowerCase())) ||
    (admission.so_dien_thoai && admission.so_dien_thoai.includes(searchQuery)) ||
    (admission.so_dien_thoai_phu_huynh && admission.so_dien_thoai_phu_huynh.includes(searchQuery))
  );
  ...
  const handleDrop = async (e: React.DragEvent, status: AdmissionStatus) => {
    ...
    setAdmissions(prev => prev.map(a => 
      a.id === admissionId ? { ...a, trang_thai: status } : a
    ));
          ...
          {selectedAdmission && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedAdmission.so_dien_thoai && (
                      <div>
                        <p className="text-sm text-muted-foreground">Số điện thoại</p>
                        <p>{selectedAdmission.so_dien_thoai}</p>
                      </div>
                    )}
                    {selectedAdmission.zalo && (
                      <div>
              ...
              <div className="space-y-3">
                ...
                {selectedAdmission.mieu_ta_hoc_sinh && (
                  <div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  {selectedAdmission.ngay_lien_he_dau && (
                    <div>
