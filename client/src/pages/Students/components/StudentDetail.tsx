...
import { CalendarDays, MapPin, Book, School, Phone, Mail, FileText, User, Layers, CreditCard, Plus } from 'lucide-react';
...
const StudentDetail: React.FC<StudentDetailProps> = ({ student, facilities = {} }) => {
  ...
  const handleAddFinance = () => {
    if (student?.id) {
      navigate(`/finance/new?entityType=hoc_sinh&entityId=${student.id}`);
    }
  };
  ...
  return (
    <Tabs defaultValue="info">
      ...
      <TabsContent value="info" className="space-y-4">
        ...
        {/* Personal and Contact Information - Side by side layout */}
      ...
      <TabsContent value="finance" className="space-y-4">
        <EntityFinancesView 
          entityType="hoc_sinh" 
          entityId={student.id} 
          entityName={student.ten_hoc_sinh || student.ho_va_ten}
        />
      </TabsContent>
